...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__global_js__ = __webpack_require__(38);
...
function signup(registration) {
    registration.onSubmit(formdata => {
        ...
        userService.signup(formdata[0], formdata[1], formdata[2]).then(() => userService.login(formdata[0], formdata[2])).then(() => new __WEBPACK_IMPORTED_MODULE_3__modules_router__["default"]().go('/game')).then(() => {
            let username = formdata[0];
            document.body.innerHTML += `<div id="user-menu" style="position:absolute;top: 0;  background: white;right: 0;"><p style="margin: 4px;">${username}
                            </p><a id="logout" style="margin: 4px;">Logout</a></div>`;
            document.getElementById('logout').addEventListener('click', function () {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__InitiativeLine__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Unit__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Pathfinding__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Background__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__GameManager__ = __webpack_require__(40);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Tile_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Skill_js__ = __webpack_require__(16);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__block_block__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__views_info_info__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__views_scoreboard_scoreboard__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__views_singleplay_web__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__views_multiplayer_registration_module_charlist__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__views_multiplayer_choose_choose__ = __webpack_require__(61);
...
const choose = new __WEBPACK_IMPORTED_MODULE_7__views_multiplayer_registration_module_charlist__["a" /* default */]();
const scoreboard = new __WEBPACK_IMPORTED_MODULE_5__views_scoreboard_scoreboard__["a" /* default */]();
const typeGame = new __WEBPACK_IMPORTED_MODULE_8__views_multiplayer_choose_choose__["a" /* default */]();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__forms_validation__ = __webpack_require__(6);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./custom-module.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./custom-module.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_router__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__singleplay_DemoGameModule__ = __webpack_require__(15);
...
class MainPage extends __WEBPACK_IMPORTED_MODULE_0__baseview__["a" /* default */] {
    ...
    creation() {
        if (document.querySelector('div.wrapper') === null) {
            let game = new __WEBPACK_IMPORTED_MODULE_4__singleplay_DemoGameModule__["a" /* default */]();
            game.stopGameLoop();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Skill__ = __webpack_require__(16);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__DungeonMapMaker__ = __webpack_require__(39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Tile__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Action__ = __webpack_require__(18);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__blocks_block_block__ = __webpack_require__(19);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseview__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__info_scss__ = __webpack_require__(50);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./scoreboard.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./scoreboard.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseview__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__DemoGameModule__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Loading__ = __webpack_require__(56);
...
class SinglePlay extends __WEBPACK_IMPORTED_MODULE_0__baseview__["a" /* default */] {
    ...
    creation() {
        ...
        let loading = new __WEBPACK_IMPORTED_MODULE_2__Loading__["a" /* default */]();
...
class Loading {
    constructor() {
        ...
        this.engine = new __WEBPACK_IMPORTED_MODULE_0__GraphicEngine__["a" /* default */]('loading', true);
        let loader = new __WEBPACK_IMPORTED_MODULE_2__Loader__["a" /* default */](['/views/singleplay/animations/loading2.png'], this.engine.gl);
        loader.load(function (texture) {
            this.engine.addColorSprite([0, 0], __WEBPACK_IMPORTED_MODULE_1__Utils__["a" /* default */].madeRectangle(-1, 1, 1, -1), [231 / 255, 223 / 255, 221 / 255, 1], true);
            let id = this.engine.addSprite([0, 0], texture[0], __WEBPACK_IMPORTED_MODULE_1__Utils__["a" /* default */].madeRectangle(-0.5, 0.5 * global.ratio, 0.5, -0.5 * global.ratio), true, __WEBPACK_IMPORTED_MODULE_1__Utils__["a" /* default */].madeRectangle(0, 0, 1 / 9, 1 / 10));
            this.engine.render();
            let timeA = 2;
            let countFrames = 90;
            let colls = 9;
            ...
            function FrameAnim(now) {
                ...
                if (deltaTime >= timeA) {
                    ...
                    let frame = Math.floor(deltaTime % timeA / timeA * countFrames);
                    this.engine.sprites[id].setTexCoord(__WEBPACK_IMPORTED_MODULE_1__Utils__["a" /* default */].madeRectangle(frame % colls / colls, Math.floor(frame / colls) / rows, (frame % colls + 1) / colls, (Math.floor(frame / colls) + 1) / rows));
                    requestAnimationFrame(FrameAnim.bind(this));
                }
            }
        }.bind(this));
...
class Choose extends __WEBPACK_IMPORTED_MODULE_0__baseview__["a" /* default */] {
    ...
    leftbar() {
        ...
        document.querySelector('a.delete').addEventListener('click', () => {
            new __WEBPACK_IMPORTED_MODULE_2__custom_module_custom_module__["a" /* default */]().creation('Coming soon....', true);
        });
...
class GameType {
    creation() {
        ...
        document.querySelector('a.multi').addEventListener('click', () => {
            new __WEBPACK_IMPORTED_MODULE_1__custom_module_custom_module__["a" /* default */]().creation('Coming soon....', true);
        });
...
/* harmony export (immutable) */ __webpack_exports__["a"] = GameType;
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/sass-loader/lib/loader.js!./choose.scss", function() {
			var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/sass-loader/lib/loader.js!./choose.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
module.exports = "data:image/png;base64,"
